        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Pour batter on hot oiled pan.</li>
                    <li>Flip when solid on bottom.</li>
                    <li>Serve when golden brown.</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                Please <a id="wd-github" href="https://github.com/ethtang/kanbas-react-web-app">click here</a> to visit the Kanbas repository.<br />
            </div>
        </div>
    );
}  